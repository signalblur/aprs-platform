...
RSpec.describe PhysiologicalEffect, type: :model do
  describe "factory" do
    it "has a valid default factory" do
      expect(build(:physiological_effect)).to be_valid
    end

    it "has a valid without_optional_fields factory" do
      expect(build(:physiological_effect, :without_optional_fields)).to be_valid
    end
  end
